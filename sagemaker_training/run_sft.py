...
def main():
    ...
    model_args, data_args, training_args = parser.parse_yaml_file('hyperparameters_config.yaml')
    ...
    raw_datasets = get_datasets(
        ...
        columns_to_keep=["messages", "chosen", "rejected", "prompt", "completion", "label", "text"],
    )
    logger.info(
    ...
    print('train max mem:', torch.cuda.max_memory_allocated()/1024/1024/1024)
    ...
    training_args.output_dir = f"{os.environ['TRANSFORMERS_CACHE']}/{training_args.output_dir}"
